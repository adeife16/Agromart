...
?>
    <main class="no-main">
        <div class="section-slide--default">
            <div class="owl-carousel owl-loaded owl-drag" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on">
                
                
                
            <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2700px, 0px, 0px); transition: all 0s ease 0s; width: 9450px;"><div class="owl-item cloned" style="width: 1350px;"><div class="ps-banner"><img class="mobile-only" src="assets/images/slide_02_mobile.png" alt="alt"><img class="desktop-only" src="assets/images/slide_02.png" alt="alt">
                    <div class="ps-content">
                        <div class="container">
                            <div class="ps-content-box">
                                ...
                                <div class="ps-shopnow"> <a href="http://nouthemes.net/html/farmart/shop-view-grid.html">Shop Now<i class="icon-chevron-right"></i></a></div>
                            </div>
                        </div>
                    </div>
                </div></div><div class="owl-item cloned" style="width: 1350px;"><div class="ps-banner"><img class="mobile-only" src="assets/images/slide_03_mobile.png" alt="alt"><img class="desktop-only" src="assets/images/slide_03.png" alt="alt">
                    <div class="ps-content">
                        <div class="container">
                            <div class="ps-content-box">
                ...
                </div></div><div class="owl-item active" style="width: 1350px;"><div class="ps-banner"><img class="mobile-only" src="assets/images/slide_01_mobile.png" alt="alt"><img class="desktop-only" src="assets/images/slide_01.png" alt="alt">
                    <div class="ps-content">
                        <div class="container">
                            <div class="ps-content-box">
                ...
                </div></div><div class="owl-item" style="width: 1350px;"><div class="ps-banner"><img class="mobile-only" src="assets/images/slide_02_mobile.png" alt="alt"><img class="desktop-only" src="assets/images/slide_02.png" alt="alt">
                    <div class="ps-content">
                        <div class="container">
                            <div class="ps-content-box">
                                <div class="ps-node"><span class="text-success">NEW ARRIVALS</span></div>
                ...
                </div></div><div class="owl-item" style="width: 1350px;"><div class="ps-banner"><img class="mobile-only" src="assets/images/slide_03_mobile.png" alt="alt"><img class="desktop-only" src="assets/images/slide_03.png" alt="alt">
                    <div class="ps-content">
                        <div class="container">
                            <div class="ps-content-box">
                                <div class="ps-node"><span class="text-danger">SALE UP TO 30%</span></div>
                ...
                </div></div><div class="owl-item cloned" style="width: 1350px;"><div class="ps-banner"><img class="mobile-only" src="assets/images/slide_01_mobile.png" alt="alt"><img class="desktop-only" src="assets/images/slide_01.png" alt="alt">
                    <div class="ps-content">
                        <div class="container">
                            <div class="ps-content-box">
                                <div class="ps-title">AgroMart Organic Fruit &amp; Vegetable Delivery <br> <span class="text-danger">Daily Offers.</span></div>
                                <div class="ps-subtitle">With our deverse range of <span class="text-success">100% fresh</span> foods.</div>
                                <div class="ps-shopnow"> <a href="http://nouthemes.net/html/farmart/shop-view-grid.html">Shop Now<i class="icon-chevron-right"></i></a></div>
                            </div>
                        </div>
                    </div>
                </div></div><div class="owl-item cloned" style="width: 1350px;"><div class="ps-banner"><img class="mobile-only" src="assets/images/slide_02_mobile.png" alt="alt"><img class="desktop-only" src="assets/images/slide_02.png" alt="alt">
                    <div class="ps-content">
                        <div class="container">
                            <div class="ps-content-box">
                                <div class="ps-node"><span class="text-success">NEW ARRIVALS</span></div>
